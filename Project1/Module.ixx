...
void Derive(double num1, double num2) {
	num1 *= num2;
	--num2;
	std::cout << num1 << "x^" << num2 << "\n";
}
void Integrate(double num1, double num2) {
	++num2;
	num1 /= num2;
	std::cout << num1 << "x^" << num2 << "\n";
}
...
int main() {
	...
	"Exponent", "Root", "Derive", "Integrate"
	};
	...
	do {
		...
		if (userInput == 1) {
			...
			if (num1 == 0 || num2 == 0) {
				std::cout << "Can not Derive with 0\n";
			}
			else {
			Derive(num1, num2);
		}
			...
			if (num1 == 0 || num2 == 0) {
				std::cout << "Can not Integrate with 0\n";
			}
			else {
				Integrate(num1, num2);
			}
